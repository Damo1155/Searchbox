...
/***/ "./src/TS/Enums/KeyboardEventTypes.js":
/*!********************************************!*\
  !*** ./src/TS/Enums/KeyboardEventTypes.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"KeyboardEventTypes\": () => (/* binding */ KeyboardEventTypes)\n/* harmony export */ });\nvar KeyboardEventTypes;\n(function (KeyboardEventTypes) {\n    KeyboardEventTypes[\"EnterKeyCode\"] = \"Enter\";\n    KeyboardEventTypes[\"SpaceKeyCode\"] = \"Space\";\n})(KeyboardEventTypes || (KeyboardEventTypes = {}));\n\n//# sourceURL=webpack://Searchbox/./src/TS/Enums/KeyboardEventTypes.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InitialiseExpanderListeners\": () => (/* binding */ InitialiseExpanderListeners),\n/* harmony export */   \"DestroyExpanderListeners\": () => (/* binding */ DestroyExpanderListeners),\n/* harmony export */   \"CollapseContainer\": () => (/* binding */ CollapseContainer)\n/* harmony export */ });\n/* harmony import */ var Enums_EventListenerTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Enums/EventListenerTypes */ \"./src/TS/Enums/EventListenerTypes.js\");\n/* harmony import */ var Enums_KeyboardEventTypes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Enums/KeyboardEventTypes */ \"./src/TS/Enums/KeyboardEventTypes.js\");\n/* harmony import */ var Shared_Constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Shared/Constants */ \"./src/TS/Shared/Constants.js\");\n/* harmony import */ var Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Services/SessionManagementService */ \"./src/TS/Services/SessionManagementService.js\");\n/* harmony import */ var Services_MarkupService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! Services/MarkupService */ \"./src/TS/Services/MarkupService.js\");\n/* harmony import */ var Listeners_SearchContainerListeners__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! Listeners/SearchContainerListeners */ \"./src/TS/Listeners/SearchContainerListeners.js\");\n/* harmony import */ var Listeners_SelectableOptionsListeners__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Listeners/SelectableOptionsListeners */ \"./src/TS/Listeners/SelectableOptionsListeners.js\");\n\n\n\n\n\n\n\nconst InitialiseExpanderListeners = (rootElement, uuid) => {\n    rootElement.addEventListener(Enums_EventListenerTypes__WEBPACK_IMPORTED_MODULE_0__.EventListenerTypes.FocusOut, (event) => {\n        if (!rootElement.contains(event.relatedTarget)) {\n            CollapseContainer(rootElement, uuid, true);\n        }\n    });\n    [Enums_EventListenerTypes__WEBPACK_IMPORTED_MODULE_0__.EventListenerTypes.Click, Enums_EventListenerTypes__WEBPACK_IMPORTED_MODULE_0__.EventListenerTypes.Keyup]\n        .forEach((eventType) => {\n        rootElement.querySelector(\".sb-selection\")\n            .addEventListener(eventType, (event) => {\n            const listenerConfiguration = {\n                \"click\": () => {\n                    ExpandableEventHandler(rootElement, event, uuid);\n                },\n                \"keyup\": () => {\n                    const keyboardEvent = event;\n                    if (keyboardEvent.code == Enums_KeyboardEventTypes__WEBPACK_IMPORTED_MODULE_1__.KeyboardEventTypes.SpaceKeyCode || keyboardEvent.code == Enums_KeyboardEventTypes__WEBPACK_IMPORTED_MODULE_1__.KeyboardEventTypes.EnterKeyCode) {\n                        ExpandableEventHandler(rootElement, event, uuid);\n                    }\n                }\n            };\n            const callback = listenerConfiguration[eventType];\n            callback ? callback() : new Error(`No event listener configured for event type '${eventType}'`);\n        });\n    });\n};\nconst DestroyExpanderListeners = (element) => {\n    if (!element) {\n        return;\n    }\n    element.replaceWith(element.cloneNode(true));\n};\nconst CollapseContainer = (rootElement, uuid, ignoreRemove = false) => {\n    rootElement.classList.remove(\"expanded\");\n    const listboxElement = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_2__.ListboxSelectionClassPrefix}-${uuid}`);\n    listboxElement.querySelector(\"div\").setAttribute(\"aria-expanded\", `${false}`);\n    const resultsContainer = rootElement.querySelector(\".results-container\");\n    if (resultsContainer && !ignoreRemove) {\n        resultsContainer.remove();\n    }\n};\nconst ExpandableEventHandler = (rootElement, event, uuid) => {\n    const selectionContainer = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_2__.ListboxSelectionClassPrefix}-${uuid}`).querySelector(\"div\");\n    const expanderCallback = {\n        Expand: () => {\n            rootElement.classList.add(\"expanded\");\n            selectionContainer.setAttribute(\"aria-expanded\", \"true\");\n            const options = (0,Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_3__.GetJSONObject)(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_2__.SessionStorageOptionsPrefix}-${uuid}`);\n            if (options && options.length > 0) {\n                const newElement = document.createElement(\"div\");\n                newElement.innerHTML = (0,Services_MarkupService__WEBPACK_IMPORTED_MODULE_4__.GenerateResultContainerMarkup)(options, uuid);\n                rootElement.appendChild(newElement.firstElementChild);\n                (0,Listeners_SelectableOptionsListeners__WEBPACK_IMPORTED_MODULE_6__.InitialiseOptionListeners)(rootElement, uuid);\n                (0,Listeners_SearchContainerListeners__WEBPACK_IMPORTED_MODULE_5__.InitialiseSearchListeners)(rootElement, options, uuid);\n            }\n            else {\n            }\n        },\n        Collapse: () => {\n            CollapseContainer(rootElement, uuid);\n        }\n    };\n    const isExpanded = rootElement.classList.contains(\"expanded\");\n    isExpanded ? expanderCallback.Collapse() : expanderCallback.Expand();\n};\n\n//# sourceURL=webpack://Searchbox/./src/TS/Listeners/ExpandableContainerListeners.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("e9e08d74ef1f988ee784")
/******/ 	})();
/******/ 	
