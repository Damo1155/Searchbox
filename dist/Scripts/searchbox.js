...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InitialiseSelectableOptionsListeners\": () => (/* binding */ InitialiseSelectableOptionsListeners),\n/* harmony export */   \"DestroySelectableOptionsListeners\": () => (/* binding */ DestroySelectableOptionsListeners)\n/* harmony export */ });\n/* harmony import */ var Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Listeners/ExpandableContainerListeners */ \"./src/TS/Listeners/ExpandableContainerListeners.js\");\n/* harmony import */ var Shared_Constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Shared/Constants */ \"./src/TS/Shared/Constants.js\");\n\n\nconst InitialiseSelectableOptionsListeners = (parentElement, uuid) => {\n    const resultsElement = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.ResultsContainerPrefix}-${uuid}`);\n    const optionsElements = resultsElement.querySelectorAll(\"ul.options li\");\n    const hiddenInput = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.HiddenTextBoxPrefix}-${uuid}`);\n    const selectionBox = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.SelectionBoxPrefix}-${uuid}`);\n    optionsElements.forEach((element) => {\n        Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.StandardEventListeners.forEach((eventType) => {\n            element.addEventListener(eventType, (event) => {\n                const listenerConfiguration = {\n                    \"click\": () => {\n                        (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_0__.CollapseContainer)(parentElement, uuid);\n                        SetValueSelected(element, hiddenInput, selectionBox);\n                    },\n                    \"keydown\": () => {\n                        const keyboardEvent = event;\n                        if (keyboardEvent.code == Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.SpaceKeyCode || keyboardEvent.code == Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.EnterKeyCode) {\n                            (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_0__.CollapseContainer)(parentElement, uuid);\n                            SetValueSelected(element, hiddenInput, selectionBox);\n                        }\n                    },\n                    \"focusout\": () => {\n                        const focusEvent = event, hasRelatedElement = parentElement.contains(focusEvent.relatedTarget);\n                        if (!hasRelatedElement) {\n                            (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_0__.CollapseContainer)(parentElement, uuid);\n                        }\n                    }\n                };\n                const callback = listenerConfiguration[eventType];\n                if (!callback) {\n                    throw new Error(`No event listener configured for event type '${eventType}'`);\n                }\n                callback();\n            });\n        });\n    });\n};\nconst DestroySelectableOptionsListeners = (element) => {\n    Shared_Constants__WEBPACK_IMPORTED_MODULE_1__.StandardEventListeners.forEach((eventType) => {\n    });\n};\nconst SetValueSelected = (element, input, selectionBox) => {\n    input.value = element.getAttribute(\"data-value\");\n    selectionBox.innerText = element.getAttribute(\"data-text\");\n};\n\n//# sourceURL=webpack://Searchbox/./src/TS/Listeners/SelectableOptionsListeners.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("24006707dcec48c5925d")
/******/ 	})();
/******/ 	
