...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InitialiseSearchListeners\": () => (/* binding */ InitialiseSearchListeners),\n/* harmony export */   \"DestroySearchListeners\": () => (/* binding */ DestroySearchListeners)\n/* harmony export */ });\n/* harmony import */ var Shared_Constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Shared/Constants */ \"./src/TS/Shared/Constants.js\");\n/* harmony import */ var Services_MarkupService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Services/MarkupService */ \"./src/TS/Services/MarkupService.js\");\n/* harmony import */ var Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Services/SessionManagementService */ \"./src/TS/Services/SessionManagementService.js\");\n\n\n\nconst InitialiseSearchListeners = (element, uuid) => {\n    const optionsStorageKey = `${Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.SessionStorageOptionsPrefix}-${uuid}`, resultsContainer = element.querySelector(\"div.container div.results\"), searchElement = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.SearchTextBoxPrefix}-${uuid}`);\n    searchElement.addEventListener(\"input\", () => {\n        console.log(123);\n        const options = (0,Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_2__.GetJSONObject)(optionsStorageKey);\n        if (options) {\n            const mappedItems = options\n                .map((item) => {\n                const asGroup = item.options;\n                const filteredOptions = asGroup.filter((option) => {\n                    return option.text.includes(searchElement.value);\n                });\n                if ((!item.text.includes(searchElement.value)) && (!filteredOptions || filteredOptions.length == 0)) {\n                    return null;\n                }\n                return {\n                    text: item.text,\n                    options: filteredOptions\n                };\n            })\n                .filter((item) => item != null && item != undefined);\n            resultsContainer.innerHTML = (0,Services_MarkupService__WEBPACK_IMPORTED_MODULE_1__.GenerateOptionsMarkup)(mappedItems);\n        }\n    });\n};\nconst DestroySearchListeners = (element) => {\n    element.replaceWith(element.cloneNode(true));\n};\n\n//# sourceURL=webpack://Searchbox/./src/TS/Listeners/SearchContainerListeners.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InitialiseSelectableOptionsListeners\": () => (/* binding */ InitialiseSelectableOptionsListeners),\n/* harmony export */   \"DestroySelectableOptionsListeners\": () => (/* binding */ DestroySelectableOptionsListeners)\n/* harmony export */ });\n/* harmony import */ var Shared_Constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Shared/Constants */ \"./src/TS/Shared/Constants.js\");\n/* harmony import */ var Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Services/SessionManagementService */ \"./src/TS/Services/SessionManagementService.js\");\n/* harmony import */ var Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Listeners/ExpandableContainerListeners */ \"./src/TS/Listeners/ExpandableContainerListeners.js\");\n\n\n\nconst InitialiseSelectableOptionsListeners = (parentElement, uuid) => {\n    const resultsElement = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.ResultsContainerPrefix}-${uuid}`);\n    const optionsElements = resultsElement.querySelectorAll(\"ul.options li\");\n    const selectionBox = document.getElementById(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.SelectionBoxPrefix}-${uuid}`);\n    optionsElements.forEach((element) => {\n        Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.StandardEventListeners.forEach((eventType) => {\n            element.addEventListener(eventType, (event) => {\n                const listenerConfiguration = {\n                    \"click\": () => {\n                        (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_2__.CollapseContainer)(parentElement, uuid);\n                        SetValueSelected(element, selectionBox, uuid);\n                    },\n                    \"keydown\": () => {\n                        const keyboardEvent = event;\n                        if (keyboardEvent.code == Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.SpaceKeyCode || keyboardEvent.code == Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.EnterKeyCode) {\n                            (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_2__.CollapseContainer)(parentElement, uuid);\n                            SetValueSelected(element, selectionBox, uuid);\n                        }\n                    },\n                    \"focusout\": () => {\n                        const focusEvent = event, hasRelatedElement = parentElement.contains(focusEvent.relatedTarget);\n                        if (!hasRelatedElement) {\n                            (0,Listeners_ExpandableContainerListeners__WEBPACK_IMPORTED_MODULE_2__.CollapseContainer)(parentElement, uuid);\n                        }\n                    }\n                };\n                const callback = listenerConfiguration[eventType];\n                if (!callback) {\n                    throw new Error(`No event listener configured for event type '${eventType}'`);\n                }\n                callback();\n            });\n        });\n    });\n};\nconst DestroySelectableOptionsListeners = (element) => {\n    element.replaceWith(element.cloneNode(true));\n};\nconst SetValueSelected = (element, selectionBox, uuid) => {\n    selectionBox.innerText = element.getAttribute(\"data-text\");\n    (0,Services_SessionManagementService__WEBPACK_IMPORTED_MODULE_1__.SetValue)(`${Shared_Constants__WEBPACK_IMPORTED_MODULE_0__.SessionStorageValuePrefix}-${uuid}`, element.getAttribute(\"data-value\"));\n};\n\n//# sourceURL=webpack://Searchbox/./src/TS/Listeners/SelectableOptionsListeners.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("searchbox." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
/******/ 	/* webpack/runtime/getFullHash */
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("11782b9293c2b064d7c4")
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/TS/searchbox.ts");
